...
import com.example.springcrud.controller.LocContractFullController;
...
@WebMvcTest(LocContractFullController.class)
public class LocContractFullControllerTest {
    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private LocContractFullService service;
    ...
    public void createLocContract_whenPostMethod() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/spring-crud/v1/loc_contract/full")
    ...
    public void listAllLocContract_whenGetMethod()
        ...
        given(service.getContractFull(null, null)).willReturn(allEmployees);

        mockMvc.perform(get("/spring-crud/v1/loc_contract/full")
                        .contentType(APPLICATION_JSON))
    ...
    public void removeLocContractById_whenDeleteMethod() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/spring-crud/v1/loc_contract/full/" + locContract.getId().toString())
                        .contentType(APPLICATION_JSON))
    ...
    public void locContractById_whenGetMethod() throws Exception {
        ...
        mockMvc.perform(get("/spring-crud/v1/loc_contract/full/" + locContract.getId().toString())
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    public void updateLocContract_whenPut() throws Exception {
        ...
        mockMvc.perform(put("/spring-crud/v1/loc_contract/full/" + locContract.getId().toString())
                        .content(JsonUtil.toJson(locContract))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("numContract", Matchers.is(locContract.getNumContract())));
